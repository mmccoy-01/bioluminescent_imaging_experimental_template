```{r Treatment Plot, message=FALSE, warning=FALSE, fig.height=6, fig.width=11}
# Load data
...
p <- ggplot(data = processed_data, 
  ...
  output$count_table <- renderTable({
    # Filter the data based on the selected tumor injection
    ...
    # Group the filtered data by trt and imaging_date and calculate the count of id
